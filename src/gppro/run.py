...
#from models import GPExpertBus
from models.gp import GPExpertBus

gp_bus = GPExpertBus()
gp_bus.train(X_train, y_train) #.values)

test_mean, test_var = gp_bus.predict(X_test)
...
test_mean, test_var = gp_pro.predict(X_test)
